function [  ] = open_rate_file( model_path, Times, nlev, ntim, DateStrLen, rates, BOX_WALL, BOXCH, output_file_comment, output_file_created_by )
...
ncid = netcdf.create([model_path '/output/rxn_rates.nc'], 'CLOBBER');
...
for j = 1:NREACT
  ...
  netcdf.putAtt(ncid,varid(j),'units','molec cm-3 s-1')
  clear str
